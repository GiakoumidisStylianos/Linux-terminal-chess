...
Queen::Queen(int row, int col, int player) : Piece(row, col, player) {
	character = player == 1 ? 'Q' : 'q';
}

bool Queen::checkMove(int destRow, int destCol) {
...
bool Queen::checkMove2(int destRow, int destCol, Board& board) {
